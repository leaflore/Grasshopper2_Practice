...
{
    [IoId("ce36bba9-2a90-42ca-b85a-68f1549a6f52")]
    public sealed class Grasshopper2_FirstComponent : Component
    {
        public Grasshopper2_FirstComponent() : base(new Nomen(
            "Grasshopper2_FirstComponent",
        ...
        public Grasshopper2_FirstComponent(IReader reader) : base(reader) { }
        ...
        protected override IIcon IconInternal
        {
            get
            {
                return AbstractIcon.FromResource("Grasshopper2_PlugIn.Icons.FirstComponent.ghicon", GetType());
            }
        }
    }
}
